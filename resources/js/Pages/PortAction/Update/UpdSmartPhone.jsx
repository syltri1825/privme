...
export default function UpdSmartPhone(props){
    return(
        <ActionLayouts 
            auth={props.auth}
            errors={props.errors}
            header={<h2 className="font-semibold">Update Smartphone Post</h2>}
        >

            <Head title="Update Post With Image" />

            <Title intituleTitle={<h3>Update a publication with Image</h3>} ></Title>
