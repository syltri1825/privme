...
export default function UpdSmartTv(props){
    return(
        <ActionLayouts 
            auth={props.auth}
            errors={props.errors}
            header={<h2 className="font-semibold">Update Smart Tv Post</h2>}
        >

            <Head title="Update Post Smart Tv" />

            <Title intituleTitle={<h3>Update Smart Tv Publication</h3>} ></Title>
