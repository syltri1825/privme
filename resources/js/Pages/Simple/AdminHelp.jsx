...
export default function AdminHelp(props){
    ...
    return(
        <SimpleLayouts
            auth={props.auth}
            error={props.error}
            header={<h2 className="font-semibold">Help</h2>}
            activeHel={route().current('help')}
        >
            <Head title="Help"/>

            <Title intituleTitle={<h3>Instructions to facilitate your navigation on the dashboard</h3>} ></Title>

            <div className="col-md-12 text-left backlink--style">
                <BackLink backLink={route('dashboard')}></BackLink>
            </div>

            <h1 className="text--black">Hello Help ! </h1>
