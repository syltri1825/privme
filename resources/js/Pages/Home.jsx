...
export default function Home(props) {
    ...
    return (
        <>
            <Head title="Welcome to admin console" />
            <div className="hs-grid">
                <div className="hs-grid1">
                    <Link href="/">
                        <img
                ...
                <div className="hs-grid2"></div>
                <div className="hs-grid3">
                    {props.auth.user ? (
                        <Link href={route('dashboard')} className="button-a1">
                            Dashboard
                        </Link>
                    ) : (
                        <>
                            <Link href={route('register')} className="button-a2">
                                Sign Up
                            </Link>
                        </>
                    )}
                ...
                <div className='hs-grid5'>
                    <h1 className='hg-h1'>Heureux de vous revoir</h1>
                    {props.auth.user ? (
                        ''
                    ) : (
                        <>
