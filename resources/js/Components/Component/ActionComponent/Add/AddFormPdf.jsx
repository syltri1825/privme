...
export default function AddFormPdf({className, title, infoObject, description, category, message}){
...
// import PortNavLink from "@/Components/PortNavLink";
// import AppSelectForm from "../AppSelectForm";
// import { Inertia } from "@inertiajs/inertia";
// import { useForm, usePage } from "@inertiajs/inertia-react";


// export default function PortAddFormPdf({className, title, infoObject, description, category, message}){
